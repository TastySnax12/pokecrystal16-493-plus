...
ENDM
	...
	map_attributes NewBarkTown, NEW_BARK_TOWN, $05, NORTH
	connection north, Route29, ROUTE_29, 0

	map_attributes CherrygroveCity, CHERRYGROVE_CITY, $05, WEST
...
;	connection west, SilverCaveOutside, SILVER_CAVE_OUTSIDE, -9
	...
	map_attributes Route29, ROUTE_29, $05, SOUTH | WEST | EAST
