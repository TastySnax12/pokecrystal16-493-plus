...
ENDM
	...
	map_attributes TwinleafTown, TWINLEAF_TOWN, $05, NORTH
	connection north, Route201, ROUTE_201, 0

	map_attributes SandgemTown, SANDGEM_TOWN, $05, WEST
;	map_attributes CherrygroveCity, CHERRYGROVE_CITY, $05, NORTH | SOUTH | WEST
;	connection north, _, _, 0
;	connection south, _, _, 0
	connection west, Route201, ROUTE_201, 0
...
;	connection west, SilverCaveOutside, SILVER_CAVE_OUTSIDE, -9
	...
	map_attributes Route201, ROUTE_201, $05, SOUTH | WEST | EAST
	connection south, TwinleafTown, TWINLEAF_TOWN, 0
	connection west, LakeVerityExt, LAKE_VERITY_EXT, -10
	connection east, SandgemTown, SANDGEM_TOWN, 0

	map_attributes LakeVerityExt, LAKE_VERITY_EXT, $05, EAST
	connection east, Route201, ROUTE_201, 10
...
;	map_attributes ElmsLab, ELMS_LAB, $00, 0
	...
	map_attributes TwinleafOldLadysHouse, TWINLEAF_OLD_LADYS_HOUSE, $00, 0
	map_attributes TwinleafYoungMansHouse, TWINLEAF_YOUNG_MANS_HOUSE, $00, 0
	map_attributes SandgemPokecenter1F, SANDGEM_POKECENTER_1F, $00, 0
	map_attributes SandgemMart, SANDGEM_MART, $00, 0
	map_attributes RowansLab, ROWANS_LAB, $00, 0
	map_attributes DawnLucasHouse1F, DAWN_LUCAS_HOUSE_1F, $00, 0
	map_attributes DawnLucasHouse2F, DAWN_LUCAS_HOUSE_2F, $00, 0
	map_attributes SandgemHealHintHouse, SANDGEM_HEAL_HINT_HOUSE, $00, 0
