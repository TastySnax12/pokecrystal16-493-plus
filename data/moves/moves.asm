...
Moves2:
	move EFFECT_SPLASH,             40, NORMAL,   100, 10,   0, PHYSICAL  ;FAKE_OUT
	move EFFECT_SPLASH,             50, NORMAL,   100, 10,   0, SPECIAL   ;UPROAR
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;STOCKPILE
	move EFFECT_SPLASH,              0, NORMAL,   100, 10,   0, SPECIAL   ;SPIT_UP
	move EFFECT_SPLASH,              0, NORMAL,   100, 10,   0, STATUS    ;SWALLOW
	move EFFECT_SPLASH,            100, FIRE,      90, 10,  10, SPECIAL   ;HEAT_WAVE
	move EFFECT_SPLASH,              0, ICE,      100, 10,   0, STATUS    ;HAIL
	move EFFECT_SPLASH,              0, DARK,     100, 15,   0, STATUS    ;TORMENT
	move EFFECT_SPLASH,              0, DARK,     100, 15,   0, STATUS    ;FLATTER
	move EFFECT_SPLASH,              0, FIRE,      75, 15,   0, STATUS    ;WILL_O_WISP
	move EFFECT_SPLASH,              0, DARK,     100, 10,   0, STATUS    ;MEMENTO
	move EFFECT_SPLASH,             70, NORMAL,   100, 20,   0, PHYSICAL  ;FACADE
	move EFFECT_SPLASH,            150, FIGHTING, 100, 20,   0, PHYSICAL  ;FOCUS_PUNCH
	move EFFECT_SPLASH,             60, FIGHTING, 100, 10,   0, PHYSICAL  ;SMELLINGSALT
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;FOLLOW_ME dummy
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;NATURE_POWER
	move EFFECT_SPLASH,              0, ELECTRIC, 100, 20,   0, STATUS    ;CHARGE
	move EFFECT_SPLASH,              0, DARK,     100, 20,   0, STATUS    ;TAUNT
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;HELPING_HAND dummy
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;TRICK
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;ROLE_PLAY
	move EFFECT_SPLASH,              0, NORMAL,   100, 10,   0, STATUS    ;WISH
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;ASSIST
	move EFFECT_SPLASH,              0, GRASS,    100, 20,   0, STATUS    ;INGRAIN
	move EFFECT_SPLASH,            120, FIGHTING, 100,  5,   0, PHYSICAL  ;SUPERPOWER
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 15,   0, STATUS    ;MAGIC_COAT
	move EFFECT_SPLASH,              0, NORMAL,   100, 10,   0, STATUS    ;RECYCLE
	move EFFECT_SPLASH,             60, FIGHTING, 100, 10,   0, PHYSICAL  ;REVENGE
	move EFFECT_SPLASH,             75, NORMAL,   100, 15,   0, PHYSICAL  ;BRICK_BREAK
	move EFFECT_SPLASH,              0, NORMAL,   100, 10,   0, STATUS    ;YAWN
	move EFFECT_SPLASH,             20, DARK,     100, 20,   0, PHYSICAL  ;KNOCK_OFF
	move EFFECT_SPLASH,              1, FIGHTING, 100,  5,   0, PHYSICAL  ;ENDEAVOR
	move EFFECT_SPLASH,            150, FIRE,     100,  5,   0, SPECIAL   ;ERUPTION
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;SKILL_SWAP
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;IMPRISON
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;REFRESH
	move EFFECT_SPLASH,              0, GHOST,    100,  5,   0, STATUS    ;GRUDGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 10,   0, PHYSICAL  ;SNATCH
	move EFFECT_SPLASH,             70, NORMAL,   100, 20,  30, PHYSICAL  ;SECRET_POWER
	move EFFECT_SPLASH,             60, WATER,    100, 10,   0, PHYSICAL  ;DIVE
	move EFFECT_SPLASH,             15, FIGHTING, 100, 20,   0, PHYSICAL  ;ARM_THRUST
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;CAMOUFLAGE
	move EFFECT_SPLASH,              0, BUG,      100, 20,   0, STATUS    ;TAIL_GLOW
	move EFFECT_SPLASH,             70, PSYCHIC,  100,  5,  50, SPECIAL   ;LUSTER_PURGE
	move EFFECT_SPLASH,             70, PSYCHIC,  100,  5,  50, SPECIAL   ;MIST_BALL
	move EFFECT_SPLASH,              0, FLYING,   100, 15,   0, STATUS    ;FEATHERDANCE
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;TEETER_DANCE
	move EFFECT_SPLASH,             85, FIRE,      90, 10,  10, PHYSICAL  ;BLAZE_KICK
	move EFFECT_SPLASH,              0, GROUND,   100, 15,   0, STATUS    ;MUD_SPORT
	move EFFECT_SPLASH,             30, ICE,       90, 20,   0, PHYSICAL  ;ICE_BALL
	move EFFECT_SPLASH,             60, GRASS,    100, 15,  30, PHYSICAL  ;NEEDLE_ARM
	move EFFECT_SPLASH,              0, NORMAL,   100, 10,   0, STATUS    ;SLACK_OFF
	move EFFECT_SPLASH,             90, NORMAL,   100, 10,   0, SPECIAL   ;HYPER_VOICE
	move EFFECT_SPLASH,             50, POISON,   100, 15,  30, PHYSICAL  ;POISON_FANG
	move EFFECT_SPLASH,             75, NORMAL,    95, 10,  50, PHYSICAL  ;CRUSH_CLAW
	move EFFECT_SPLASH,            150, FIRE,      90,  5,   0, SPECIAL   ;BLAST_BURN
	move EFFECT_SPLASH,            150, WATER,    100,  5,   0, SPECIAL   ;HYDRO_CANNON
	move EFFECT_SPLASH,            100, STEEL,     80, 10,  20, PHYSICAL  ;METEOR_MASH
	move EFFECT_SPLASH,             30, GHOST,    100, 15,   0, PHYSICAL  ;ASTONISH
	move EFFECT_SPLASH,             50, NORMAL,   100, 10,   0, SPECIAL   ;WEATHER_BALL
	move EFFECT_SPLASH,              0, GRASS,    100,  5,   0, STATUS    ;AROMATHERAPY
	move EFFECT_SPLASH,              0, DARK,     100, 20,   0, STATUS    ;FAKE_TEARS
	move EFFECT_SPLASH,             55, FLYING,    95, 25,   0, SPECIAL   ;AIR_CUTTER
	move EFFECT_SPLASH,            140, FIRE,      90,  5,   0, SPECIAL   ;OVERHEAT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0, STATUS    ;ODOR_SLEUTH
	move EFFECT_SPLASH,             50, NORMAL,    80, 10,   0, PHYSICAL  ;ROCK_TOMB
	move EFFECT_SPLASH,             60, NORMAL,   100,  5,   0, SPECIAL   ;SILVER_WIND
	move EFFECT_SPLASH,              0, NORMAL,    85, 40,   0, STATUS    ;METAL_SOUND
	move EFFECT_SPLASH,              0, NORMAL,    55, 15,   0, STATUS    ;GRASSWHISTLE
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;TICKLE
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;COSMIC_POWER
	move EFFECT_SPLASH,            150, NORMAL,   100,  5,   0, SPECIAL   ;WATER_SPOUT
	move EFFECT_SPLASH,             75, BUG,      100, 15,  10, SPECIAL   ;SIGNAL_BEAM
	move EFFECT_SPLASH,             60, GHOST,    100, 20,   0, PHYSICAL  ;SHADOW_PUNCH
	move EFFECT_SPLASH,             80, PSYCHIC,  100, 30,   0, SPECIAL   ;EXTRASENSORY
	move EFFECT_SPLASH,             85, FIGHTING,  90, 15,   0, PHYSICAL  ;SKY_UPPERCUT
	move EFFECT_SPLASH,             15, GROUND,    70, 15,  50, PHYSICAL  ;SAND_TOMB
	move EFFECT_SPLASH,              1, ICE,       30,  5,   0, SPECIAL   ;SHEER_COLD
	move EFFECT_SPLASH,             95, WATER,     85, 10,  30, SPECIAL   ;MUDDY_WATER
	move EFFECT_SPLASH,             10, GRASS,    100, 30,   0, PHYSICAL  ;BULLET_SEED
	move EFFECT_SPLASH,             60, FLYING,   100, 20,   0, PHYSICAL  ;AERIAL_ACE
	move EFFECT_SPLASH,             10, ICE,      100, 30,   0, PHYSICAL  ;ICICLE_SPEAR
	move EFFECT_SPLASH,              0, STEEL,    100, 15,   0, STATUS    ;IRON_DEFENSE
	move EFFECT_SPLASH,              0, NORMAL,   100,  5,   0, STATUS    ;BLOCK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0, STATUS    ;HOWL
	move EFFECT_SPLASH,             80, DRAGON,   100, 15,   0, PHYSICAL  ;DRAGON_CLAW
	move EFFECT_SPLASH,            150, GRASS,     90,  5,   0, SPECIAL   ;FRENZY_PLANT
	move EFFECT_SPLASH,              0, FIGHTING, 100, 20,   0, STATUS    ;BULK_UP
	move EFFECT_SPLASH,             85, FLYING,    95,  5,  30, PHYSICAL  ;BOUNCE
	move EFFECT_SPLASH,             55, GROUND,    95, 15, 100, SPECIAL   ;MUD_SHOT
	move EFFECT_SPLASH,             50, POISON,   100, 25,  10, PHYSICAL  ;POISON_TAIL
	move EFFECT_SPLASH,             40, NORMAL,   100, 40,   0, PHYSICAL  ;COVET
	move EFFECT_SPLASH,            120, ELECTRIC, 100, 15,  10, PHYSICAL  ;VOLT_TACKLE
	move EFFECT_SPLASH,             60, GRASS,    100, 20,   0, SPECIAL   ;MAGICAL_LEAF
	move EFFECT_SPLASH,              0, WATER,    100, 15,   0, STATUS    ;WATER_SPORT
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 20,   0, STATUS    ;CALM_MIND
	move EFFECT_SPLASH,             70, GRASS,    100, 15,   0, PHYSICAL  ;LEAF_BLADE
	move EFFECT_SPLASH,              0, DRAGON,   100, 20,   0, STATUS    ;DRAGON_DANCE
	move EFFECT_SPLASH,             25, ROCK,      80, 10,   0, PHYSICAL  ;ROCK_BLAST
	move EFFECT_SPLASH,             60, ELECTRIC, 100, 20,   0, SPECIAL   ;SHOCK_WAVE
	move EFFECT_SPLASH,             60, WATER,    100, 20,  20, SPECIAL   ;WATER_PULSE
	move EFFECT_SPLASH,            140, STEEL,    100,  5,   0, SPECIAL   ;DOOM_DESIREbuffed
	move EFFECT_SPLASH,            140, PSYCHIC,   90,  5,   0, SPECIAL   ;PSYCHO_BOOST
	move EFFECT_SPLASH,              0, FLYING,   100, 10,   0, STATUS    ;ROOST
	move EFFECT_SPLASH,              0, PSYCHIC,  100,  5,   0, STATUS    ;GRAVITY
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 40,   0, STATUS    ;MIRACLE_EYE
	move EFFECT_SPLASH,             60, FIGHTING, 100, 10,   0, PHYSICAL  ;WAKE_UP_SLAP
	move EFFECT_SPLASH,            100, FIGHTING,  90, 10,   0, PHYSICAL  ;HAMMER_ARM
	move EFFECT_SPLASH,              0, STEEL,    100,  5,   0, PHYSICAL  ;GYRO_BALL
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;HEALING_WISH
	move EFFECT_SPLASH,             65, WATER,    100, 10,   0, SPECIAL   ;BRINE
	move EFFECT_SPLASH,              0, NORMAL,   100, 15,   0, PHYSICAL  ;NATURAL_GIFT
	move EFFECT_SPLASH,             50, NORMAL,   100, 10,   0, PHYSICAL  ;FEINT
	move EFFECT_SPLASH,             60, FLYING,   100, 20,   0, PHYSICAL  ;PLUCK
	move EFFECT_SPLASH,              0, FLYING,   100, 30,   0, STATUS    ;TAILWIND
	move EFFECT_SPLASH,              0, NORMAL,   100, 30,   0, STATUS    ;ACUPRESSURE
	move EFFECT_SPLASH,              0, STEEL,    100, 10,   0, PHYSICAL  ;METAL_BURST
	move EFFECT_SPLASH,             70, BUG,      100, 20,   0, PHYSICAL  ;U_TURN
	move EFFECT_SPLASH,            120, FIGHTING, 100,  5,   0, PHYSICAL  ;CLOSE_COMBAT
	move EFFECT_SPLASH,             50, DARK,     100, 10,   0, PHYSICAL  ;PAYBACK
	move EFFECT_SPLASH,             50, DARK,     100, 10,   0, PHYSICAL  ;ASSURANCE
	move EFFECT_SPLASH,              0, DARK,     100, 15,   0, STATUS    ;EMBARGO
	move EFFECT_SPLASH,              0, DARK,     100, 10,   0, PHYSICAL  ;FLING
	move EFFECT_SPLASH,              0, PSYCHIC,   90, 10,   0, STATUS    ;PSYCHO_SHIFT
	move EFFECT_SPLASH,              0, NORMAL,   100,  5,   0, SPECIAL   ;TRUMP_CARD
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 15,   0, STATUS    ;HEAL_BLOCK
	move EFFECT_SPLASH,              0, NORMAL,   100,  5,   0, SPECIAL   ;WRING_OUT
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;POWER_TRICK
	move EFFECT_SPLASH,              0, POISON,   100, 10,   0, STATUS    ;GASTRO_ACID
	move EFFECT_SPLASH,              0, NORMAL,   100, 30,   0, STATUS    ;LUCKY_CHANT
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;ME_FIRST
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;COPYCAT
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;POWER_SWAP
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;GUARD_SWAP
	move EFFECT_SPLASH,             60, DARK,     100,  5,   0, PHYSICAL  ;PUNISHMENT
	move EFFECT_SPLASH,            130, NORMAL,   100,  5,   0, PHYSICAL  ;LAST_RESORT
	move EFFECT_SPLASH,              0, GRASS,    100, 10,   0, STATUS    ;WORRY_SEED
	move EFFECT_SPLASH,             80, DARK,     100,  5,   0, PHYSICAL  ;SUCKER_PUNCH
	move EFFECT_SPLASH,              0, POISON,   100, 20,   0, STATUS    ;TOXIC_SPIKES
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;HEART_SWAP
	move EFFECT_SPLASH,              0, WATER,    100, 20,   0, STATUS    ;AQUA_RING
	move EFFECT_SPLASH,              0, ELECTRIC, 100, 10,   0, STATUS    ;MAGNET_RISE
	move EFFECT_SPLASH,            120, FIRE,     100, 15,  10, PHYSICAL  ;FLARE_BLITZ
	move EFFECT_SPLASH,            120, FIGHTING, 100, 15,  30, PHYSICAL  ;FORCE_PALM
	move EFFECT_SPLASH,             90, FIGHTING, 100, 20,   0, SPECIAL   ;AURA_SPHERE
	move EFFECT_SPLASH,              0, ROCK,     100, 20,   0, STATUS    ;ROCK_POLISH
	move EFFECT_SPLASH,             80, POISON,   100, 20,  30, PHYSICAL  ;POISON_JAB
	move EFFECT_SPLASH,             80, DARK,     100, 15,  20, SPECIAL   ;DARK_PULSE
	move EFFECT_SPLASH,             70, DARK,     100, 15,   0, PHYSICAL  ;NIGHT_SLASH
	move EFFECT_SPLASH,             90, WATER,     90, 10,   0, PHYSICAL  ;AQUA_TAIL
	move EFFECT_SPLASH,             80, GRASS,    100, 15,   0, PHYSICAL  ;SEED_BOMB
	move EFFECT_SPLASH,             75, FLYING,    95, 20,  30, SPECIAL   ;AIR_SLASH
	move EFFECT_SPLASH,             80, BUG,      100, 15,   0, PHYSICAL  ;X_SCISSOR
	move EFFECT_SPLASH,             90, BUG,      100, 10,  10, SPECIAL   ;BUG_BUZZ
	move EFFECT_SPLASH,             90, DRAGON,   100, 10,   0, SPECIAL   ;DRAGON_PULSE
	move EFFECT_SPLASH,            100, DRAGON,    75, 10,  20, PHYSICAL  ;DRAGON_RUSH
	move EFFECT_SPLASH,             80, ROCK,     100, 20,   0, SPECIAL   ;POWER_GEM
	move EFFECT_SPLASH,             75, FIGHTING, 100, 10,   0, PHYSICAL  ;DRAIN_PUNCH
	move EFFECT_SPLASH,             40, FIGHTING, 100, 30,   0, SPECIAL   ;VACUUM_WAVE
	move EFFECT_SPLASH,            120, FIGHTING,  70,  5,  10, SPECIAL   ;FOCUS_BLAST
	move EFFECT_SPLASH,             90, GRASS,    100, 10,  10, SPECIAL   ;ENERGY_BALL
	move EFFECT_SPLASH,            120, FLYING,   100, 15,   0, PHYSICAL  ;BRAVE_BIRD
	move EFFECT_SPLASH,             90, GROUND,   100, 10,  10, SPECIAL   ;EARTH_POWER
	move EFFECT_SPLASH,              0, DARK,     100, 10,   0, STATUS    ;SWITCHEROO
	move EFFECT_SPLASH,            150, NORMAL,    90,  5,   0, PHYSICAL  ;GIGA_IMPACT
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 20,   0, STATUS    ;NASTY_PLOT
	move EFFECT_SPLASH,             40, FIGHTING, 100, 30,   0, PHYSICAL  ;BULLET_PUNCH
	move EFFECT_SPLASH,             60, ICE,      100, 10,   0, PHYSICAL  ;AVALANCHE
	move EFFECT_SPLASH,             40, ICE,      100, 30,   0, PHYSICAL  ;ICE_SHARD
	move EFFECT_SPLASH,             70, GHOST,    100, 15,   0, PHYSICAL  ;SHADOW_CLAW
	move EFFECT_SPLASH,             65, ELECTRIC,  95, 15,  10, PHYSICAL  ;THUNDER_FANG
	move EFFECT_SPLASH,             65, ICE,       95, 15,  10, PHYSICAL  ;ICE_FANG
	move EFFECT_SPLASH,             65, FIRE,      95, 15,  10, PHYSICAL  ;FIRE_FANG
	move EFFECT_SPLASH,             40, GHOST,    100, 30,   0, PHYSICAL  ;SHADOW_SNEAK
	move EFFECT_SPLASH,             65, GROUND,    85, 10,  30, SPECIAL   ;MUD_BOMB
	move EFFECT_SPLASH,             70, PSYCHIC,  100, 20,   0, PHYSICAL  ;PSYCHO_CUT
	move EFFECT_SPLASH,             80, PSYCHIC,   90, 15,  20, PHYSICAL  ;ZEN_HEADBUTT
	move EFFECT_SPLASH,             65, STEEL,     85, 10,  30, SPECIAL   ;MIRROR_SHOT
	move EFFECT_SPLASH,             80, STEEL,    100, 10,  10, SPECIAL   ;FLASH_CANNON
	move EFFECT_SPLASH,             90, NORMAL,    85, 20,  20, PHYSICAL  ;ROCK_CLIMB
	move EFFECT_SPLASH,              0, FLYING,   100, 15,   0, STATUS    ;DEFOG
	move EFFECT_SPLASH,              0, PSYCHIC,  100,  5,   0, STATUS    ;TRICK_ROOM
	move EFFECT_SPLASH,            140, DRAGON,    90,  5,   0, SPECIAL   ;DRACO_METEOR
	move EFFECT_SPLASH,             80, ELECTRIC, 100, 15,  30, SPECIAL   ;DISCHARGE
	move EFFECT_SPLASH,             80, FIRE,     100, 15,  30, SPECIAL   ;LAVA_PLUME
	move EFFECT_SPLASH,            140, GRASS,     90,  5,   0, SPECIAL   ;LEAF_STORM
	move EFFECT_SPLASH,            120, GRASS,     85, 10,   0, PHYSICAL  ;POWER_WHIP
	move EFFECT_SPLASH,            150, ROCK,      90,  5,   0, PHYSICAL  ;ROCK_WRECKER
	move EFFECT_SPLASH,             70, POISON,    90, 20,  10, PHYSICAL  ;CROSS_POISON
	move EFFECT_SPLASH,            120, POISON,    70,  5,  30, PHYSICAL  ;GUNK_SHOT
	move EFFECT_SPLASH,             80, STEEL,     90, 15,  30, PHYSICAL  ;IRON_HEAD
	move EFFECT_SPLASH,             60, STEEL,    100, 20,   0, PHYSICAL  ;MAGNET_BOMB
	move EFFECT_SPLASH,            100, ROCK,      80,  5,   0, PHYSICAL  ;STONE_EDGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 20,   0, STATUS    ;CAPTIVATE
	move EFFECT_SPLASH,              0, ROCK,     100, 20,   0, STATUS    ;STEALTH_ROCK
	move EFFECT_SPLASH,              0, GRASS,    100, 20,   0, SPECIAL   ;GRASS_KNOT
	move EFFECT_SPLASH,             60, FLYING,   100, 20,  31, SPECIAL   ;CHATTER
	move EFFECT_SPLASH,            100, NORMAL,   100, 10,   0, SPECIAL   ;JUDGMENT
	move EFFECT_SPLASH,             60, BUG,      100, 20,   0, PHYSICAL  ;BUG_BITE
	move EFFECT_SPLASH,             50, ELECTRIC,  90, 10,  70, SPECIAL   ;CHARGE_BEAM
	move EFFECT_SPLASH,            120, GRASS,    100, 15,   0, PHYSICAL  ;WOOD_HAMMER
	move EFFECT_SPLASH,             40, WATER,    100, 20,   0, PHYSICAL  ;AQUA_JET
	move EFFECT_SPLASH,             90, BUG,      100, 15,   0, PHYSICAL  ;ATTACK_ORDER
	move EFFECT_SPLASH,              0, BUG,      100, 10,   0, STATUS    ;DEFEND_ORDER
	move EFFECT_SPLASH,              0, BUG,      100, 10,   0, STATUS    ;HEAL_ORDER
	move EFFECT_SPLASH,            150, ROCK,      80,  5,   0, PHYSICAL  ;HEAD_SMASH
	move EFFECT_SPLASH,             35, NORMAL,    90, 10,   0, PHYSICAL  ;DOUBLE_HIT
	move EFFECT_SPLASH,            150, DRAGON,    90,  5,   0, SPECIAL   ;ROAR_OF_TIME
	move EFFECT_SPLASH,            100, DRAGON,    95,  5,   0, SPECIAL   ;SPACIAL_REND
	move EFFECT_SPLASH,              0, PSYCHIC,  100, 10,   0, STATUS    ;LUNAR_DANCE
	move EFFECT_SPLASH,              0, NORMAL,   100,  5,   0, PHYSICAL  ;CRUSH_GRIP
	move EFFECT_SPLASH,            120, FIRE,      70,  5,   0, SPECIAL   ;MAGMA_STORM
	move EFFECT_SPLASH,              0, DARK,      80, 10,   0, STATUS    ;DARK_VOID
	move EFFECT_SPLASH,            120, GRASS,     85,  5,  40, SPECIAL   ;SEED_FLARE
	move EFFECT_SPLASH,             60, GHOST,    100,  5,  10, SPECIAL   ;OMINOUS_WIND
	move EFFECT_SPLASH,            120, GHOST,    100,  5,   0, PHYSICAL  ;SHADOW_FORCE
	move EFFECT_SPLASH,            140, ROCK,      90,  5,   0, SPECIAL   ;CORAL_BEAMCORSOLA_SIGNATURE
	move EFFECT_SPLASH,            140, FLYING,    90,  5,   0, PHYSICAL  ;POT_SMASHFARFETCH'D_SIGNATURE
