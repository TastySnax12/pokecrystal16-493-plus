...
Moves2:
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FAKE_OUT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;UPROAR
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;STOCKPILE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SPIT_UP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SWALLOW
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HEAT_WAVE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HAIL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TORMENT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FLATTER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WILL_O_WISP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MEMENTO
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FACADE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FOCUS_PUNCH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SMELLINGSALT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FOLLOW_ME
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;NATURE_POWER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CHARGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TAUNT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HELPING_HAND
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TRICK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ROLE_PLAY
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WISH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ASSIST
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;INGRAIN
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SUPERPOWER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MAGIC_COAT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;RECYCLE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;REVENGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BRICK_BREAK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;YAWN
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;KNOCK_OFF
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ENDEAVOR
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ERUPTION
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SKILL_SWAP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;IMPRISON
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;REFRESH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GRUDGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SNATCH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SECRET_POWER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DIVE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ARM_THRUST
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CAMOUFLAGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TAIL_GLOW
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;LUSTER_PURGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MIST_BALL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FEATHERDANCE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TEETER_DANCE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BLAZE_KICK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MUD_SPORT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ICE_BALL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;NEEDLE_ARM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SLACK_OFF
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HYPER_VOICE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;POISON_FANG
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CRUSH_CLAW
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BLAST_BURN
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HYDRO_CANNON
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;METEOR_MASH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ASTONISH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WEATHER_BALL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AROMATHERAPY
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FAKE_TEARS
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AIR_CUTTER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;OVERHEAT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ODOR_SLEUTH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ROCK_TOMB
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SILVER_WIND
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;METAL_SOUND
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GRASSWHISTLE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TICKLE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;COSMIC_POWER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WATER_SPOUT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SIGNAL_BEAM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SHADOW_PUNCH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;EXTRASENSORY
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SKY_UPPERCUT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SAND_TOMB
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SHEER_COLD
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MUDDY_WATER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BULLET_SEED
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AERIAL_ACE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ICICLE_SPEAR
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;IRON_DEFENSE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BLOCK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HOWL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DRAGON_CLAW
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FRENZY_PLANT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BULK_UP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BOUNCE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MUD_SHOT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;POISON_TAIL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;COVET
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;VOLT_TACKLE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MAGICAL_LEAF
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WATER_SPORT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CALM_MIND
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;LEAF_BLADE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DRAGON_DANCE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ROCK_BLAST
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SHOCK_WAVE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WATER_PULSE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DOOM_DESIRE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;PSYCHO_BOOST
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ROOST
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GRAVITY
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MIRACLE_EYE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WAKE_UP_SLAP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HAMMER_ARM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GYRO_BALL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HEALING_WISH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BRINE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;NATURAL_GIFT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FEINT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;PLUCK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TAILWIND
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ACUPRESSURE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;METAL_BURST
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;U_TURN
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CLOSE_COMBAT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;PAYBACK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ASSURANCE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;EMBARGO
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FLING
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;PSYCHO_SHIFT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TRUMP_CARD
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HEAL_BLOCK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WRING_OUT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;POWER_TRICK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GASTRO_ACID
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;LUCKY_CHANT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ME_FIRST
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;COPYCAT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;POWER_SWAP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GUARD_SWAP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;PUNISHMENT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;LAST_RESORT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WORRY_SEED
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SUCKER_PUNCH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TOXIC_SPIKES
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HEART_SWAP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AQUA_RING
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MAGNET_RISE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FLARE_BLITZ
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FORCE_PALM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AURA_SPHERE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ROCK_POLISH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;POISON_JAB
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DARK_PULSE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;NIGHT_SLASH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AQUA_TAIL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SEED_BOMB
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AIR_SLASH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;X_SCISSOR
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BUG_BUZZ
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DRAGON_PULSE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DRAGON_RUSH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;POWER_GEM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DRAIN_PUNCH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;VACUUM_WAVE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FOCUS_BLAST
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ENERGY_BALL
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BRAVE_BIRD
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;EARTH_POWER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SWITCHEROO
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GIGA_IMPACT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;NASTY_PLOT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BULLET_PUNCH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AVALANCHE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ICE_SHARD
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SHADOW_CLAW
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;THUNDER_FANG
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ICE_FANG
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FIRE_FANG
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SHADOW_SNEAK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MUD_BOMB
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;PSYCHO_CUT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ZEN_HEADBUTT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MIRROR_SHOT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;FLASH_CANNON
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ROCK_CLIMB
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DEFOG
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;TRICK_ROOM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DRACO_METEOR
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DISCHARGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;LAVA_PLUME
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;LEAF_STORM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;POWER_WHIP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ROCK_WRECKER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CROSS_POISON
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GUNK_SHOT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;IRON_HEAD
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MAGNET_BOMB
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;STONE_EDGE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CAPTIVATE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;STEALTH_ROCK
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;GRASS_KNOT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CHATTER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;JUDGMENT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;BUG_BITE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CHARGE_BEAM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;WOOD_HAMMER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;AQUA_JET
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ATTACK_ORDER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DEFEND_ORDER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HEAL_ORDER
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;HEAD_SMASH
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DOUBLE_HIT
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;ROAR_OF_TIME
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SPACIAL_REND
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;LUNAR_DANCE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;CRUSH_GRIP
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;MAGMA_STORM
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;DARK_VOID
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SEED_FLARE
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;OMINOUS_WIND
	move EFFECT_SPLASH,              0, NORMAL,   100, 40,   0 ;SHADOW_FORCE
