...
Moves2:
	...
	move EFFECT_SPLASH,              0, FIGHTING, 100, 5,    0, PHYSICAL ;ENDEAVOR
	...
	move EFFECT_SPLASH,             65, POISON,    95, 15,  30, PHYSICAL ;POISON_FANG
	move EFFECT_SPLASH,             75, NORMAL,    95, 10,  50, PHYSICAL ;CRUSH_CLAW
	move EFFECT_SPLASH,            150, FIRE,      90, 5,    0, SPECIAL  ;BLAST_BURN
	move EFFECT_SPLASH,            150, WATER,     90, 5,    0, SPECIAL  ;HYDRO_CANNON
	...
	move EFFECT_SPLASH,             15, GROUND,    70, 15,   0, PHYSICAL ;SAND_TOMB
	move EFFECT_SPLASH,              0, ICE,       30, 5,    0, SPECIAL  ;SHEER_COLD
	...
	move EFFECT_SPLASH,            140, STEEL,    100, 5,    0, SPECIAL  ;DOOM_DESIRE ; buffed
	...
	move EFFECT_SPLASH,            140, ROCK,      90, 5,    0, SPECIAL  ;CORAL_BEAM ; CORSOLA_SIGNATURE
	move EFFECT_SPLASH,            140, FLYING,    90, 5,    0, PHYSICAL ;POT_SMASH ; FARFETCH'D_SIGNATURE
