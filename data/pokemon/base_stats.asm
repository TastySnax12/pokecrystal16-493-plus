...
INCLUDE "data/pokemon/base_stats/shellos_b.asm"
INCLUDE "data/pokemon/base_stats/gastrodon_b.asm"
...
INCLUDE "data/pokemon/base_stats/giratina_b.asm"
INCLUDE "data/pokemon/base_stats/shaymin_b.asm"
POPS
