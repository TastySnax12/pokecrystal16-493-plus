...
; wPlayerSubStatus5 or wEnemySubStatus5 bit flags
	...
	enum SUBSTATUS_TORMENT
	enum SUBSTATUS_CHARGE
	enum SUBSTATUS_TOXIC

; wPlayerSubStatus6 or wEnemuSubStatus6 bit flags
	enum_start 7, -1
	enum SUBSTATUS_UPROAR
	enum SUBSTATUS_STOCKPILE_2
	enum SUBSTATUS_STOCKPILE_1
	enum SUBSTATUS_TAUNT
	enum SUBSTATUS_GASTRO_ACID
