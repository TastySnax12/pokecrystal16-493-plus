...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_TWINLEAF
	const ENGINE_FLYPOINT_SANDGEM
	const ENGINE_FLYPOINT_3
	const ENGINE_FLYPOINT_4
	const ENGINE_FLYPOINT_5
	const ENGINE_FLYPOINT_6
	const ENGINE_FLYPOINT_7
	const ENGINE_FLYPOINT_8
	const ENGINE_FLYPOINT_9
	const ENGINE_FLYPOINT_10
	const ENGINE_FLYPOINT_11
	const ENGINE_FLYPOINT_12
	const ENGINE_FLYPOINT_13 ; 40
	const ENGINE_FLYPOINT_14
	const ENGINE_FLYPOINT_15
	const ENGINE_FLYPOINT_16
	const ENGINE_FLYPOINT_17
	const ENGINE_FLYPOINT_18
	const ENGINE_FLYPOINT_19
	const ENGINE_FLYPOINT_20
	const ENGINE_FLYPOINT_21
	const ENGINE_FLYPOINT_22
	const ENGINE_FLYPOINT_23
	const ENGINE_FLYPOINT_24
	const ENGINE_FLYPOINT_25
	const ENGINE_FLYPOINT_26
